...
def run():
    ...
    print " *****************************************************"
    print " *****************************************************"
    print " ***  ELAYV    V2.0  Commmunity Edition***************"
    print " *****************************************************"
    ...
    verification = re.search(r'^(2[0-5]{2}|[01]?[0-9]{0,2})\.(2[0-5]{0,2}|[01]?[0-9]{0,2})\.(2[0-5]{0,2}|[01]?[0-9]{0,2})\.(2[0-5]{2}|[01]?[0-9]{0,2})/[0-9]+$', ip_input)
